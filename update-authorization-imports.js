...
function updateImports(filePath) {
  try {
    ...
    // Check if the file imports from @/lib/authorization
    if (content.includes('from "@/lib/authorization"') || content.includes("from '@/lib/authorization'")) {
      // Replace the imports
      content = content.replace(/from ["']@\/lib\/authorization["']/g, 'from "@/lib/auth/authorization"');
